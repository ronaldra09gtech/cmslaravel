                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{ asset('backend/') }}advance-rangeslider.html">Range Slider</a></li>
                                    <li><a href="{{ asset('backend/') }}advance-roundslider.html">Round Slider</a></li>
                                    <li><a href="{{ asset('backend/') }}advance-session-timeout.html">Session Timeout</a></li>
                                    <li><a href="{{ asset('backend/') }}advance-sweet-alert.html">Sweetalert 2</a></li>
                                    <li><a href="{{ asset('backend/') }}advance-rating.html">Rating</a></li>
                                    <li><a href="{{ asset('backend/') }}advance-notifications.html">Notifications</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{ asset('backend/') }}icons-remix.html">Remix Icons</a></li>
                                    <li><a href="{{ asset('backend/') }}icons-materialdesign.html">Material Design</a></li>
                                    <li><a href="{{ asset('backend/') }}icons-dripicons.html">Dripicons</a></li>
                                    <li><a href="{{ asset('backend/') }}icons-fontawesome.html">Font awesome 5</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{ asset('backend/') }}maps-google.html">Google Maps</a></li>
                                    <li><a href="{{ asset('backend/') }}maps-vector.html">Vector Maps</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="true">
                                    <li><a href="{{ asset('backend/') }}javascript: void(0);">Level 1.1</a></li>
                                    <li><a href="{{ asset('backend/') }}javascript: void(0);" class="has-arrow">Level 1.2</a>
                                        <ul class="sub-menu" aria-expanded="true">
                                            <li><a href="{{ asset('backend/') }}javascript: void(0);">Level 2.1</a></li>
                                            <li><a href="{{ asset('backend/') }}javascript: void(0);">Level 2.2</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
